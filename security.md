...
- GitHub → the [wickra-genome repository](https://github.com/wickra-lib/wickra-genome)
...
Wickra Genome parses untrusted `ScanSpec` JSON and candle data, so its parser and
...
[SECURITY.md](https://github.com/wickra-lib/wickra-genome/blob/main/SECURITY.md)
